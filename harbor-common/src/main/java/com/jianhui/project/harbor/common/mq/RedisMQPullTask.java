...
public class RedisMQPullTask implements CommandLineRunner {
    ...
    private static final ScheduledExecutorService EXECUTOR = ThreadPoolExecutorFactory.getThreadPoolExecutor();
    ...
    private List<Object> pullBatch(String key, int batchSize) {
