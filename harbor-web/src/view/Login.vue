      ...
      >
        <el-form-item label="用户名" prop="username">
          <el-input
              ...
              clearable
              size="large"
              type="text" v-model="loginForm.username" autocomplete="off" placeholder="请输入用户名">
          </el-input>
        </el-form-item>
        <el-form-item label="密码" prop="password">
          <el-input
              ...
              size="large"
              show-password
              type="password" v-model="loginForm.password" autocomplete="off" placeholder="请输入密码">
          </el-input>
        </el-form-item>
        <el-form-item label="验证码" prop="captcha">
          <div class="captcha-container">
            <el-input
                ...
                clearable
                size="large"
                v-model="loginForm.captcha" type="text" placeholder="验证码">
            </el-input>
