    ...
    <div class="input-outer">
      ...
      <div class="option">
        ...
        <file-upload
          ...
          ref="imageUploader"
          :url="'/image/upload'"
          @before="onUploadImageBefore"
          @upload-success="onUploadImageSuccess"
          @upload-fail="onUploadImageFail"
          :max-size="IMAGE_MSG_MAX_SIZE"
        ...
        <file-upload
          ...
          ref="fileUploader"
          :url="'/file/upload'"
          @before="onUploadFileBefore"
          @upload-success="onUploadFileSuccess"
          @upload-fail="onUploadFileFail"
        ...
        <img
          title="音频通话"
          src="../../../assets/input/phone-call.svg"
          alt="电话"
          class="icon"
