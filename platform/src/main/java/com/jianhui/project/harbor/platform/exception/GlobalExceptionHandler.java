package com.jianhui.project.harbor.platform.exception;
...
public class GlobalExceptionHandler {
    ...
    public Result handleException(Exception e) {
        if (e instanceof GlobalException) {
            ...
            return Results.error(ResultCode.PROGRAM_ERROR);
        }
    }
    ...
    public Result handleMessageNotReadableException(HttpMessageNotReadableException e) {
        ...
        if (t instanceof JSONException) {
            ...
            if (t instanceof DateTimeParseException) {
                return Results.error(ResultCode.PROGRAM_ERROR, "日期格式不正确");
            }
            return Results.error(ResultCode.PROGRAM_ERROR, "数据格式不正确");
        }
        return Results.error(ResultCode.PROGRAM_ERROR);
    }
    ...
    public Result handleValidationExceptionHandler(MethodArgumentNotValidException exception) {
        ...
        return Results.error(ResultCode.PROGRAM_ERROR, msg);
    }
    ...
    public Result handleBindException(BindException e) {
        ...
        return Results.error(ResultCode.PROGRAM_ERROR, errorMsg);
    }
}
